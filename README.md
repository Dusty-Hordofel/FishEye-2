...
### 11. Manage the navigation between the home page and the photographer page

- [handle likes systeme](js/pages/photographer.js)
...
- [filter medias](/js/pages/photographer.js)

```js
/*handle sorting medias*/
function sorts(sortBy) {
  //select all medias
  let listePhotos = document.querySelectorAll(".photograph-work-container");
  //create an array
  let tableauTrier = [];
...
- create [openLightbox](/js/pages/photographer.js)
